...
!****************************************************************************
     ...
     PROGRAM ONED_LINEAR_CONVECTION
     IMPLICIT NONE 
     ...
     DO J= 0,NT
       PRINT*,"AT TIME", DT*J,"SECONDS, VARIABLES = ""X"",""U"" "
       WRITE(2,*),"AT TIME", DT*J,"SECONDS, VARIABLES = ""X"",""U"" "

       DO I=1,40
          UN(I)=U(I)-(C*DT/DX)*(U(I)-U(I-1)) !!! IF CHANGE IN DX OR DT IS REQUIRED, IT SHOULD SATISFY THE CFL CONDITION.     
          PRINT*,I,UN(I)
          WRITE(2,*),I,UN(I)
       END DO
    ...
    END PROGRAM ONED_LINEAR_CONVECTION
